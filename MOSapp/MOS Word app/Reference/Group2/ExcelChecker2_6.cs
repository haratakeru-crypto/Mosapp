    ...
    public class ExcelChecker2_6
    {
        public bool CheckTask_2_6_01()
        {
            try
            {
                ...
                return CheckTask_2_6_01_Impl(filePath);
            }
            catch (Exception)
            {
                return false;
        ...
        public bool CheckTask_2_6_02()
        {
            try
            {
                ...
                return CheckTask_2_6_02_Impl(filePath);
            }
            catch (Exception)
            {
                return false;
        ...
        public bool CheckTask_2_6_03()
        {
            try
            {
                ...
                return CheckTask_2_6_03_Impl(filePath);
            }
            catch (Exception)
            {
                return false;
        ...
        public bool CheckTask_2_6_04()
        {
            try
            {
                ...
                return CheckTask_2_6_04_Impl(filePath);
            }
            catch (Exception)
            {
                return false;
        ...
        public bool CheckTask_2_6_05()
        {
            try
            {
                ...
                return CheckTask_2_6_05_Impl(filePath);
            }
            catch (Exception)
            {
                return false;
