    ...
    public class ExcelChecker2_9
    {
        public bool CheckTask_2_9_01()
        {
            try
            {
                ...
                return CheckTask_2_9_01_Impl(filePath);
            }
            catch (Exception)
            {
                return false;
        ...
        public bool CheckTask_2_9_02()
        {
            try
            {
                ...
                return CheckTask_2_9_02_Impl(filePath);
            }
            catch (Exception)
            {
                return false;
        ...
        public bool CheckTask_2_9_03()
        {
            try
            {
                ...
                return CheckTask_2_9_03_Impl(filePath);
            }
            catch (Exception)
            {
                return false;
        ...
        public bool CheckTask_2_9_04()
        {
            try
            {
                ...
                return CheckTask_2_9_04_Impl(filePath);
            }
            catch (Exception)
            {
                return false;
        ...
        public bool CheckTask_2_9_05()
        {
            try
            {
                ...
                return CheckTask_2_9_05_Impl(filePath);
            }
            catch (Exception)
            {
                return false;
