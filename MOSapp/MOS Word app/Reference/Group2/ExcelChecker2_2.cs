    ...
    public class ExcelChecker2_2
    {
        public bool CheckTask_2_2_01()
        {
            try
            {
                ...
                return CheckTask_2_2_01_Impl(filePath);
            }
            catch (Exception)
            {
                return false;
        ...
        public bool CheckTask_2_2_02()
        {
            try
            {
                ...
                return CheckTask_2_2_02_Impl(filePath);
            }
            catch (Exception)
            {
                return false;
        ...
        public bool CheckTask_2_2_03()
        {
            try
            {
                ...
                return CheckTask_2_2_03_Impl(filePath);
            }
            catch (Exception)
            {
                return false;
        ...
        public bool CheckTask_2_2_04()
        {
            try
            {
                ...
                return CheckTask_2_2_04_Impl(filePath);
            }
            catch (Exception)
            {
                return false;
        ...
        public bool CheckTask_2_2_05()
        {
            try
            {
                ...
                return CheckTask_2_2_05_Impl(filePath);
            }
            catch (Exception)
            {
                return false;
