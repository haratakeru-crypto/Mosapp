    ...
    public class ExcelChecker2_7
    {
        public bool CheckTask_2_7_01()
        {
            try
            {
                ...
                return CheckTask_2_7_01_Impl(filePath);
            }
            catch (Exception)
            {
                return false;
        ...
        public bool CheckTask_2_7_02()
        {
            try
            {
                ...
                return CheckTask_2_7_02_Impl(filePath);
            }
            catch (Exception)
            {
                return false;
        ...
        public bool CheckTask_2_7_03()
        {
            try
            {
                ...
                return CheckTask_2_7_03_Impl(filePath);
            }
            catch (Exception)
            {
                return false;
        ...
        public bool CheckTask_2_7_04()
        {
            try
            {
                ...
                return CheckTask_2_7_04_Impl(filePath);
            }
            catch (Exception)
            {
                return false;
        ...
        public bool CheckTask_2_7_05()
        {
            try
            {
                ...
                return CheckTask_2_7_05_Impl(filePath);
            }
            catch (Exception)
            {
                return false;
