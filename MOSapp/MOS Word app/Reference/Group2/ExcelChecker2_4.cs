    ...
    public class ExcelChecker2_4
    {
        public bool CheckTask_2_4_01()
        {
            try
            {
                ...
                return CheckTask_2_4_01_Impl(filePath);
            }
            catch (Exception)
            {
                return false;
        ...
        public bool CheckTask_2_4_02()
        {
            try
            {
                ...
                return CheckTask_2_4_02_Impl(filePath);
            }
            catch (Exception)
            {
                return false;
        ...
        public bool CheckTask_2_4_03()
        {
            try
            {
                ...
                return CheckTask_2_4_03_Impl(filePath);
            }
            catch (Exception)
            {
                return false;
        ...
        public bool CheckTask_2_4_04()
        {
            try
            {
                ...
                return CheckTask_2_4_04_Impl(filePath);
            }
            catch (Exception)
            {
                return false;
        ...
        public bool CheckTask_2_4_05()
        {
            try
            {
                ...
                return CheckTask_2_4_05_Impl(filePath);
            }
            catch (Exception)
            {
                return false;
