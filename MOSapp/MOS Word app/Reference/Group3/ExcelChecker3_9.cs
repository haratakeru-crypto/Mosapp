...
namespace Libraries.Group3
{
    public class ExcelChecker3_9
    {
        ...
        private bool CheckTask_3_9_01(string filePath)
        {
            if (string.IsNullOrEmpty(filePath))
                return false;
        ...
        private bool CheckTask_3_9_02(string filePath)
        {
            if (string.IsNullOrEmpty(filePath))
                return false;
        ...
        private bool CheckTask_3_9_03(string filePath)
        {
            if (string.IsNullOrEmpty(filePath))
                return false;
        ...
        private bool CheckTask_3_9_04(string filePath)
        {
            if (string.IsNullOrEmpty(filePath))
                return false;
        ...
        private bool CheckTask_3_9_05(string filePath)
        {
            if (string.IsNullOrEmpty(filePath))
                return false;
        ...
        private bool CheckTask_3_9_06(string filePath)
        {
            if (string.IsNullOrEmpty(filePath))
                return false;
