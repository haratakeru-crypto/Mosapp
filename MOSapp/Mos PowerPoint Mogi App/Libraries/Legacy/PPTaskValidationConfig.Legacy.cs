// =============================================================================
// PPTaskValidationConfig.Legacy.cs — 破壊的操作免除設定の参照用スナップショット
// =============================================================================
// ビルド対象外（.csproj に含めない）。実行時は Libraries/PPTaskValidationConfig.cs のみが有効。
// 作成: 2026-06-17 / P3 完了時点（P4 着手前）の現行設定を固定。
// 対応表: tasks/PP_類題採点対応表.md「破壊的操作免除一覧」
// git: 作業ツリー時点（HEAD 参考 `4840fd5`）。MD/Legacy で判断できないときのみ git log を参照。
// =============================================================================
