// =============================================================================
// PPTaskValidationConfig.Legacy.cs — 破壊的操作免除設定の参照用スナップショット（凍結）
// =============================================================================
// 【重要】Px 実装時に本ファイルを編集しない。Checker の *.Legacy.cs と同じ運用。
// 実行時に有効なのは Libraries/PPTaskValidationConfig.cs のみ（本ファイルは .csproj 未収録）。
// 新タスクの免除設定は PPTaskValidationConfig.cs + ThisAddIn.cs + 対応表 MD を更新すること。
//
// スナップショット: P3 完了時点（P4 着手前）。旧 projectId 4〜11 の taskId のまま固定。
// 作成: 2026-06-17 / git: 37275f4（PP_Project3採点完了）時点を復元基準。
// 参照: tasks/PP_類題採点対応表.md「破壊的操作免除一覧」「旧→新移植メモ」
// =============================================================================
