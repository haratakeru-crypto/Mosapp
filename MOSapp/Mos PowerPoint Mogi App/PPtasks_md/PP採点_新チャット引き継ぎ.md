...
| **P6** | **完了・検証済** | P6-1〜7 連続採点○。破壊的操作免除は全タスクなし（調整不要） |
| P7〜P11 | 未着手 | |
...
P6 と同じ **Phase A（骨格）→ Phase B（タスク単位実装）** で進める。詳細は [`tasks/PP_類題採点対応表.md`](../tasks/PP_類題採点対応表.md) の P7 セクションを参照。
